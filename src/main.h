...
// Copyright (c) 2013-2014 FooCoin developers
...
static const unsigned int MAX_TX_COMMENT_LEN_V1 = 140; // FooCoin: 128 bytes + little extra
...
static const int64 MAX_MONEY = 160000000 * COIN; // FooCoin: maximum of 160 million coins
